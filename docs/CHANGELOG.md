...
## 2025-10-28 修改：
- 开播新日报明细表字段顺序调整：按照用户需求重新排列字段顺序为主播、状态、播时、流水、当日毛利、3日平均流水、底薪、主播分类、当前分成比例、性别年龄、直属运营、开播地点、主播分成、公司分成，提升报表阅读体验。
- 快速月报明细表字段顺序调整：按照用户需求重新排列字段顺序为主播、性别年龄、直属运营、主播分类、月累计开播记录数、月均播时(小时)、月累计流水(元)、日均毛利（元）、月累计毛利(元)、月累计主播分成(元)、月累计公司分成(元)、月最新返点比例(%)、月累计返点(元)、月累计底薪(元)，优化报表布局逻辑。
- 开播周报明细表字段顺序调整：按照用户需求重新排列字段顺序为主播、周累计开播记录数、前一周开播记录数、周均播时(小时)、前一周均播时、周累计流水(元)、前一周累积流水、周累计毛利(元)、前一周累积毛利、周累计底薪(元)、直属运营、性别年龄、主播分类、周累计主播分成(元)、周累计公司分成(元)，优化周环比分析布局。
