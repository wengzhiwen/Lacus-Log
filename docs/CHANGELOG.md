...
2025-09-27  修复
- 通告日历日视图：修复汉堡菜单层叠问题，调整时间标题行z-index从10降为1，解决菜单无法完全覆盖表头的问题
- 主播业绩页：新增主播业绩查看功能
- 通告日历日视图：修复主播直属运营显示问题，现在正确显示运营昵称而非用户名
- 开播日报：修复日报明细中主播性别显示问题，现在正确显示性别图标（♂/♀）而非问号
- 开播日报：修复日报明细表头中开播平台列标题，改为开播地点
