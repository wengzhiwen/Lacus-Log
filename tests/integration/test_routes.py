...
class TestRouteConfiguration:
    ...
    def test_route_urls(self, app):
        ...
        with app.app_context():
            ...
            # 测试管理路由
            assert url_for('admin.users_list') == '/admin/users'
            assert url_for('admin.users_new') == '/admin/users/new'
            assert url_for('admin.users_toggle_active', user_id='test') == '/admin/users/test/toggle'
            assert url_for('admin.users_reset_password', user_id='test') == '/admin/users/test/reset'
