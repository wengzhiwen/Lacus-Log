...
def _calculate_dashboard_data():
    ...
    recruit_today_official = Recruit.objects(
        final_decision_time__gte=today_start_utc,
        final_decision_time__lt=today_end_utc,
        final_decision=FinalDecision.OFFICIAL
    ).count()
    
    # 新增实习机师：今日完成结束征召决策且征召为实习机师的数量
    recruit_today_intern = Recruit.objects(
        final_decision_time__gte=today_start_utc,
        final_decision_time__lt=today_end_utc,
...
<div class="card" id="recruitCard" style="cursor: pointer;">
  ...
  <div class="card-body">
    ...
    <div class="sub-data">
      <div class="sub-item">
        <div class="sub-value">{{ dashboard_data.recruit_today_official }}</div>
        <div class="sub-label">新增正式机师</div>
      </div>
      <div class="sub-item">
        <div class="sub-value">{{ dashboard_data.recruit_today_intern }}</div>
        <div class="sub-label">新增实习机师</div>
      </div>
    </div>
  </div>
</div>
...
- **新增正式机师**：基于final_decision_time和final_decision字段，统计今日决定征召为正式机师的数量
- **新增实习机师**：基于final_decision_time和final_decision字段，统计今日决定征召为实习机师的数量
